    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', backpage.models.DateTimeDateField(auto_now=True, verbose_name='导入时间')),
            ],
            options={
                'verbose_name': '广告',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createtime', backpage.models.DateTimeDateField(null=True, verbose_name='创建时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('starttime', backpage.models.DateTimeDateField(auto_now=True, verbose_name='发起时间')),
                ('endtime', backpage.models.DateTimeDateField(null=True, verbose_name='结束时间')),
                ...
                ('accepttime', backpage.models.DateTimeDateField(null=True, verbose_name='接单时间')),
                ('finishtime', backpage.models.DateTimeDateField(null=True, verbose_name='完成订单时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('time', backpage.models.DateTimeDateField(auto_now=True, verbose_name='服务时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_type', backpage.models.TinyIntField(choices=[(0, '小型货车'), (1, '大型货车'), (2, '小型平板'), (3, '中型平板'), (4, '大型平板')], db_column='type', default=0, verbose_name='车辆类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pre_login_time', backpage.models.DateTimeDateField(auto_now=True, verbose_name='上次登录时间')),
                ('signup_time', backpage.models.DateTimeDateField(auto_now=True, verbose_name='登录时间')),
        ...
        migrations.AddField(
            model_name='truck',
            name='lessee',
            field=models.OneToOneField(db_column='lessee', on_delete=django.db.models.deletion.CASCADE, to='backpage.Lessee', verbose_name='货车主id'),
        ),
        migrations.AddField(
            model_name='orders',
            name='lessee',
